...
pub enum ParityBlock {
    ...
    MossCarpet = 81,
    RootedDirt = 82,
    // P8 vegetal-decoration alphabet (overworld). Appended (discriminants ≥ 83)
    // so the P2–P5 fixture digest alphabet is untouched. These are the outputs of
    // the `simple_block` / `block_column` / `bamboo` / `kelp` / `seagrass` /
    // `vegetation_patch` / `lake` features: grasses, ferns, flowers, mushrooms,
    // gourds, bushes, aquatic plants, and the lush-caves moss set. Property
    // carrying blocks (double-plant `half`, sugar-cane/cactus `age`, sea-pickle
    // `pickles`, kelp `age`, pale-moss-carpet `bottom`) collapse to their default
    // block state per the established precedent; every vanilla RNG draw is still
    // consumed 1:1 (see `features.rs`). Double plants collapse to a single default
    // (lower-half) state.
    ShortGrass = 83,
    Fern = 84,
    TallGrass = 85,
    ...
    Bamboo = 132,
    BambooSapling = 133,
    // P8 frozen/ice + desert/rock + underground + dripstone + coral feature
    // alphabet. Appended (discriminants ≥ 134) so the existing fixture digest
    // alphabet (0..=133) is untouched. Property-carrying blocks (pointed
    // dripstone thickness/direction/waterlogged, amethyst bud facing/waterlogged,
    // coral-fan facing, sandstone-slab type) collapse to their default block
    // state per the established precedent; every vanilla RNG draw is consumed 1:1
    // (see `features.rs`). Block entities (spawner mob, chest / suspicious-sand
    // loot tables) are not modeled in worldgen — the block state is placed and
    // the vanilla RNG (mob nextInt, loot nextLong) is consumed, but the NBT is
    // deferred (see `features.rs`).
    BlueIce = 134,
    MossyCobblestone = 135,
    Cobblestone = 136,
    SandstoneSlab = 137,
    SuspiciousSand = 138,
    Spawner = 139,
    ...
    AmethystBlock = 144,
    AmethystCluster = 145,
    LargeAmethystBud = 146,
    MediumAmethystBud = 147,
    SmallAmethystBud = 148,
    DripstoneBlock = 149,
    PointedDripstone = 150,
    // Coral (warm-ocean). Five colours each of coral block / coral (upright) /
    // coral fan / coral wall fan, so `getRandomElementOf(#coral_blocks|#corals|
    // #wall_corals)` selects a modeled block 1:1 with the vanilla registry order.
    TubeCoralBlock = 151,
    BrainCoralBlock = 152,
    BubbleCoralBlock = 153,
    FireCoralBlock = 154,
    HornCoralBlock = 155,
    TubeCoral = 156,
    BrainCoral = 157,
    ...
    FireCoralFan = 164,
    HornCoralFan = 165,
    TubeCoralWallFan = 166,
    BrainCoralWallFan = 167,
...
impl ParityBlock {
    ...
    pub const ALL: [ParityBlock; 171] = [
        ...
        ParityBlock::ShortGrass,
        ParityBlock::Fern,
        ParityBlock::TallGrass,
        ParityBlock::LargeFern,
        ParityBlock::ShortDryGrass,
        ParityBlock::TallDryGrass,
        ParityBlock::Bush,
        ParityBlock::DeadBush,
        ParityBlock::LeafLitter,
        ParityBlock::Dandelion,
        ParityBlock::Poppy,
        ParityBlock::BlueOrchid,
        ParityBlock::Allium,
        ParityBlock::AzureBluet,
        ParityBlock::RedTulip,
        ParityBlock::OrangeTulip,
        ParityBlock::WhiteTulip,
        ParityBlock::PinkTulip,
        ParityBlock::OxeyeDaisy,
        ParityBlock::Cornflower,
        ParityBlock::LilyOfTheValley,
        ParityBlock::Sunflower,
        ParityBlock::Lilac,
        ParityBlock::RoseBush,
        ParityBlock::Peony,
        ParityBlock::PinkPetals,
        ParityBlock::Wildflowers,
        ParityBlock::ClosedEyeblossom,
        ParityBlock::FireflyBush,
        ParityBlock::BrownMushroom,
        ParityBlock::RedMushroom,
        ParityBlock::Pumpkin,
        ParityBlock::Melon,
        ParityBlock::SweetBerryBush,
        ParityBlock::SugarCane,
        ParityBlock::Cactus,
        ParityBlock::CactusFlower,
        ParityBlock::LilyPad,
        ParityBlock::Kelp,
        ParityBlock::KelpPlant,
        ParityBlock::Seagrass,
        ParityBlock::TallSeagrass,
        ParityBlock::SeaPickle,
        ParityBlock::MossBlock,
        ParityBlock::Azalea,
        ParityBlock::FloweringAzalea,
        ParityBlock::PaleMossCarpet,
        ParityBlock::PaleMossBlock,
        ParityBlock::SporeBlossom,
        ParityBlock::Bamboo,
        ParityBlock::BambooSapling,
        ParityBlock::BlueIce,
        ParityBlock::MossyCobblestone,
        ParityBlock::Cobblestone,
        ParityBlock::SandstoneSlab,
        ParityBlock::SuspiciousSand,
        ParityBlock::Spawner,
        ParityBlock::Chest,
        ParityBlock::MagmaBlock,
        ParityBlock::SmoothBasalt,
        ParityBlock::BuddingAmethyst,
        ParityBlock::AmethystBlock,
        ParityBlock::AmethystCluster,
        ParityBlock::LargeAmethystBud,
        ParityBlock::MediumAmethystBud,
        ParityBlock::SmallAmethystBud,
        ParityBlock::DripstoneBlock,
        ParityBlock::PointedDripstone,
    ...
    pub fn block_name(self) -> &'static str {
        match self {
            ...
            ParityBlock::ShortGrass => "minecraft:short_grass",
            ParityBlock::Fern => "minecraft:fern",
            ParityBlock::TallGrass => "minecraft:tall_grass",
            ParityBlock::LargeFern => "minecraft:large_fern",
            ParityBlock::ShortDryGrass => "minecraft:short_dry_grass",
            ParityBlock::TallDryGrass => "minecraft:tall_dry_grass",
            ParityBlock::Bush => "minecraft:bush",
            ParityBlock::DeadBush => "minecraft:dead_bush",
            ParityBlock::LeafLitter => "minecraft:leaf_litter",
            ParityBlock::Dandelion => "minecraft:dandelion",
            ParityBlock::Poppy => "minecraft:poppy",
            ParityBlock::BlueOrchid => "minecraft:blue_orchid",
            ParityBlock::Allium => "minecraft:allium",
            ParityBlock::AzureBluet => "minecraft:azure_bluet",
            ParityBlock::RedTulip => "minecraft:red_tulip",
            ParityBlock::OrangeTulip => "minecraft:orange_tulip",
            ParityBlock::WhiteTulip => "minecraft:white_tulip",
            ParityBlock::PinkTulip => "minecraft:pink_tulip",
            ParityBlock::OxeyeDaisy => "minecraft:oxeye_daisy",
            ParityBlock::Cornflower => "minecraft:cornflower",
            ParityBlock::LilyOfTheValley => "minecraft:lily_of_the_valley",
            ParityBlock::Sunflower => "minecraft:sunflower",
            ParityBlock::Lilac => "minecraft:lilac",
            ParityBlock::RoseBush => "minecraft:rose_bush",
            ParityBlock::Peony => "minecraft:peony",
            ParityBlock::PinkPetals => "minecraft:pink_petals",
            ParityBlock::Wildflowers => "minecraft:wildflowers",
            ParityBlock::ClosedEyeblossom => "minecraft:closed_eyeblossom",
            ParityBlock::FireflyBush => "minecraft:firefly_bush",
            ParityBlock::BrownMushroom => "minecraft:brown_mushroom",
            ParityBlock::RedMushroom => "minecraft:red_mushroom",
            ParityBlock::Pumpkin => "minecraft:pumpkin",
            ParityBlock::Melon => "minecraft:melon",
            ParityBlock::SweetBerryBush => "minecraft:sweet_berry_bush",
            ParityBlock::SugarCane => "minecraft:sugar_cane",
            ParityBlock::Cactus => "minecraft:cactus",
            ParityBlock::CactusFlower => "minecraft:cactus_flower",
            ParityBlock::LilyPad => "minecraft:lily_pad",
            ParityBlock::Kelp => "minecraft:kelp",
            ParityBlock::KelpPlant => "minecraft:kelp_plant",
            ParityBlock::Seagrass => "minecraft:seagrass",
            ParityBlock::TallSeagrass => "minecraft:tall_seagrass",
            ParityBlock::SeaPickle => "minecraft:sea_pickle",
            ParityBlock::MossBlock => "minecraft:moss_block",
            ParityBlock::Azalea => "minecraft:azalea",
            ParityBlock::FloweringAzalea => "minecraft:flowering_azalea",
            ParityBlock::PaleMossCarpet => "minecraft:pale_moss_carpet",
            ParityBlock::PaleMossBlock => "minecraft:pale_moss_block",
            ParityBlock::SporeBlossom => "minecraft:spore_blossom",
            ParityBlock::Bamboo => "minecraft:bamboo",
            ParityBlock::BambooSapling => "minecraft:bamboo_sapling",
            ParityBlock::BlueIce => "minecraft:blue_ice",
            ParityBlock::MossyCobblestone => "minecraft:mossy_cobblestone",
            ParityBlock::Cobblestone => "minecraft:cobblestone",
            ParityBlock::SandstoneSlab => "minecraft:sandstone_slab",
            ParityBlock::SuspiciousSand => "minecraft:suspicious_sand",
            ParityBlock::Spawner => "minecraft:spawner",
            ParityBlock::Chest => "minecraft:chest",
            ParityBlock::MagmaBlock => "minecraft:magma_block",
            ParityBlock::SmoothBasalt => "minecraft:smooth_basalt",
            ParityBlock::BuddingAmethyst => "minecraft:budding_amethyst",
            ParityBlock::AmethystBlock => "minecraft:amethyst_block",
            ParityBlock::AmethystCluster => "minecraft:amethyst_cluster",
            ParityBlock::LargeAmethystBud => "minecraft:large_amethyst_bud",
            ParityBlock::MediumAmethystBud => "minecraft:medium_amethyst_bud",
            ParityBlock::SmallAmethystBud => "minecraft:small_amethyst_bud",
            ParityBlock::DripstoneBlock => "minecraft:dripstone_block",
            ParityBlock::PointedDripstone => "minecraft:pointed_dripstone",
            ParityBlock::TubeCoralBlock => "minecraft:tube_coral_block",
            ParityBlock::BrainCoralBlock => "minecraft:brain_coral_block",
            ParityBlock::BubbleCoralBlock => "minecraft:bubble_coral_block",
            ParityBlock::FireCoralBlock => "minecraft:fire_coral_block",
            ParityBlock::HornCoralBlock => "minecraft:horn_coral_block",
            ParityBlock::TubeCoral => "minecraft:tube_coral",
            ParityBlock::BrainCoral => "minecraft:brain_coral",
            ParityBlock::BubbleCoral => "minecraft:bubble_coral",
            ParityBlock::FireCoral => "minecraft:fire_coral",
            ParityBlock::HornCoral => "minecraft:horn_coral",
            ParityBlock::TubeCoralFan => "minecraft:tube_coral_fan",
            ParityBlock::BrainCoralFan => "minecraft:brain_coral_fan",
            ParityBlock::BubbleCoralFan => "minecraft:bubble_coral_fan",
            ParityBlock::FireCoralFan => "minecraft:fire_coral_fan",
            ParityBlock::HornCoralFan => "minecraft:horn_coral_fan",
            ParityBlock::TubeCoralWallFan => "minecraft:tube_coral_wall_fan",
            ParityBlock::BrainCoralWallFan => "minecraft:brain_coral_wall_fan",
    ...
    pub fn from_name(name: &str) -> Option<ParityBlock> {
        Some(match name.strip_prefix("minecraft:").unwrap_or(name) {
            ...
            "short_grass" => ParityBlock::ShortGrass,
            "fern" => ParityBlock::Fern,
            "tall_grass" => ParityBlock::TallGrass,
            "large_fern" => ParityBlock::LargeFern,
            "short_dry_grass" => ParityBlock::ShortDryGrass,
            "tall_dry_grass" => ParityBlock::TallDryGrass,
            "bush" => ParityBlock::Bush,
            "dead_bush" => ParityBlock::DeadBush,
            "leaf_litter" => ParityBlock::LeafLitter,
            "dandelion" => ParityBlock::Dandelion,
            "poppy" => ParityBlock::Poppy,
            "blue_orchid" => ParityBlock::BlueOrchid,
            "allium" => ParityBlock::Allium,
            "azure_bluet" => ParityBlock::AzureBluet,
            "red_tulip" => ParityBlock::RedTulip,
            "orange_tulip" => ParityBlock::OrangeTulip,
            "white_tulip" => ParityBlock::WhiteTulip,
            "pink_tulip" => ParityBlock::PinkTulip,
            "oxeye_daisy" => ParityBlock::OxeyeDaisy,
            "cornflower" => ParityBlock::Cornflower,
            "lily_of_the_valley" => ParityBlock::LilyOfTheValley,
            "sunflower" => ParityBlock::Sunflower,
            "lilac" => ParityBlock::Lilac,
            "rose_bush" => ParityBlock::RoseBush,
            "peony" => ParityBlock::Peony,
            "pink_petals" => ParityBlock::PinkPetals,
            "wildflowers" => ParityBlock::Wildflowers,
            "closed_eyeblossom" => ParityBlock::ClosedEyeblossom,
            "firefly_bush" => ParityBlock::FireflyBush,
            "brown_mushroom" => ParityBlock::BrownMushroom,
            "red_mushroom" => ParityBlock::RedMushroom,
            "pumpkin" => ParityBlock::Pumpkin,
            "melon" => ParityBlock::Melon,
            "sweet_berry_bush" => ParityBlock::SweetBerryBush,
            "sugar_cane" => ParityBlock::SugarCane,
            "cactus" => ParityBlock::Cactus,
            "cactus_flower" => ParityBlock::CactusFlower,
            "lily_pad" => ParityBlock::LilyPad,
            "kelp" => ParityBlock::Kelp,
            "kelp_plant" => ParityBlock::KelpPlant,
            "seagrass" => ParityBlock::Seagrass,
            "tall_seagrass" => ParityBlock::TallSeagrass,
            "sea_pickle" => ParityBlock::SeaPickle,
            "moss_block" => ParityBlock::MossBlock,
            "azalea" => ParityBlock::Azalea,
            "flowering_azalea" => ParityBlock::FloweringAzalea,
            "pale_moss_carpet" => ParityBlock::PaleMossCarpet,
            "pale_moss_block" => ParityBlock::PaleMossBlock,
            "spore_blossom" => ParityBlock::SporeBlossom,
            "bamboo" => ParityBlock::Bamboo,
            "bamboo_sapling" => ParityBlock::BambooSapling,
            "blue_ice" => ParityBlock::BlueIce,
            "mossy_cobblestone" => ParityBlock::MossyCobblestone,
            "cobblestone" => ParityBlock::Cobblestone,
            "sandstone_slab" => ParityBlock::SandstoneSlab,
            "suspicious_sand" => ParityBlock::SuspiciousSand,
            "spawner" => ParityBlock::Spawner,
            "chest" => ParityBlock::Chest,
            "magma_block" => ParityBlock::MagmaBlock,
            "smooth_basalt" => ParityBlock::SmoothBasalt,
            "budding_amethyst" => ParityBlock::BuddingAmethyst,
            "amethyst_block" => ParityBlock::AmethystBlock,
            "amethyst_cluster" => ParityBlock::AmethystCluster,
            "large_amethyst_bud" => ParityBlock::LargeAmethystBud,
            "medium_amethyst_bud" => ParityBlock::MediumAmethystBud,
            "small_amethyst_bud" => ParityBlock::SmallAmethystBud,
            "dripstone_block" => ParityBlock::DripstoneBlock,
            "pointed_dripstone" => ParityBlock::PointedDripstone,
            "tube_coral_block" => ParityBlock::TubeCoralBlock,
            "brain_coral_block" => ParityBlock::BrainCoralBlock,
            "bubble_coral_block" => ParityBlock::BubbleCoralBlock,
            "fire_coral_block" => ParityBlock::FireCoralBlock,
            "horn_coral_block" => ParityBlock::HornCoralBlock,
            "tube_coral" => ParityBlock::TubeCoral,
            "brain_coral" => ParityBlock::BrainCoral,
            "bubble_coral" => ParityBlock::BubbleCoral,
            "fire_coral" => ParityBlock::FireCoral,
            "horn_coral" => ParityBlock::HornCoral,
            "tube_coral_fan" => ParityBlock::TubeCoralFan,
            "brain_coral_fan" => ParityBlock::BrainCoralFan,
            "bubble_coral_fan" => ParityBlock::BubbleCoralFan,
            "fire_coral_fan" => ParityBlock::FireCoralFan,
            "horn_coral_fan" => ParityBlock::HornCoralFan,
            "tube_coral_wall_fan" => ParityBlock::TubeCoralWallFan,
            "brain_coral_wall_fan" => ParityBlock::BrainCoralWallFan,
