...
// The full generation context (position, column height, biome, level bounds, seed)
// genuinely all bear on the block choice; bundling them into a struct would only
// move the argument list, not shorten it.
